...
public class PlayerMovement : MonoBehaviour
{
    ...
    public int Power { get { return power; } } // Mainly for the Power UI slider

    [SerializeField]
    int maxPower = 20;  // Used to have a limit on how much the player can use his flight.

    public int MaxPower { get { return maxPower; } set { maxPower = value; } }  // Mainly for saving/loading the max, and the power UI.

    [SerializeField]
    GameObject lastCheckpoint; // Last used checkpoint/chargepad. Used for going back.

    public GameObject LastCheckpoint
    { // Used for saving last checkpoint.
        get
        {
